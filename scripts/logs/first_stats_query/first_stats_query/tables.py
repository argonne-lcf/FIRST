...
Each stream (request_metrics, request_log, access_log, user, batch_log, batch_metrics)
can be dumped as a
...
TIMESTAMP_COL: dict[str, str | None] = {
    "request_metrics": "timestamp_compute_request",
...
CLUSTER_COL: dict[str, str | None] = {
    "request_metrics": "cluster",
    "request_log": "cluster",
    "access_log": None,
    "user": None,
    "batch_log": "cluster",
    "batch_metrics": "cluster",
}
